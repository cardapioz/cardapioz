...
complete -c x509 -o outform --description 'This specifies the output format, the options have the same meaning as the  -…'
...
complete -c x509 -o pubkey --description 'outputs the the certificate\'s SubjectPublicKeyInfo block in \\s-1PEM\\s0 format.'
