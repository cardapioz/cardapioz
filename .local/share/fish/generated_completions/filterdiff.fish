...
complete -c filterdiff -s I -l include-from-file --description 'Include only files matching any pattern listed in FILE, one pattern per line.'
complete -c filterdiff -s x -l exclude --description 'Exclude files matching PATTERN.  All other lines in the input are displayed.'
complete -c filterdiff -s X -l exclude-from-file --description 'Exclude files matching any pattern listed in FILE, one pattern per line.'
...
complete -c filterdiff -l lines --description 'Only include hunks that contain lines from the original file that lie within …'
...
complete -c filterdiff -l addoldprefix --description 'Prefix pathnames for old or original files in the output by PREFIX.'
complete -c filterdiff -l addnewprefix --description 'Prefix pathnames for updated or new files in the output by PREFIX.'
complete -c filterdiff -l as-numbered-lines --description 'Instead of a patch fragment, display the lines of the selected hunks with the…'
