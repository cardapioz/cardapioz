...
complete -c tar -s x --description 'extract files from an archive El OTHER OPTIONS Operation modifiers: -tag -wid…'
complete -c tar -s a --description 'use archive suffix to determine the compression program.'
complete -c tar -o '\\-acls' --description 'Enable the POSIX ACLs support.'
complete -c tar -o '\\-no\\-acls' --description 'Disable the POSIX ACLs support.'
complete -c tar -o '\\-add\\-file' --description 'add given FILE to the archive (useful if its name starts with a dash).'
...
complete -c tar -o '\\-atime\\-preserve' --description 'preserve access times on dumped files, either by restoring the times after re…'
...
complete -c tar -o '\\-check\\-device' --description 'check device numbers when creating incremental archives (default).'
...
complete -c tar -o '\\-clamp\\-mtime' --description 'only set time when the file is more recent than what was given with --mtime.'
complete -c tar -o '\\-delay\\-directory\\-restore' --description 'delay setting modification times and permissions of extracted directories unt…'
...
complete -c tar -o '\\-exclude\\-caches' --description 'exclude contents of directories containing CACHEDIR.'
...
complete -c tar -o '\\-exclude\\-ignore' --description 'read exclude patterns for each directory from FILE, if it exists.'
complete -c tar -o '\\-exclude\\-ignore\\-recursive' --description 'read exclude patterns for each directory and its subdirectories from FILE, if…'
complete -c tar -o '\\-exclude\\-tag' --description 'exclude contents of directories containing FILE, except for FILE itself.'
...
complete -c tar -o '\\-exclude\\-vcs\\-ignores' --description 'read exclude patterns from the VCS ignore files.'
...
complete -c tar -s H --description 'create archive of the given formatFORMAT is one of the following: -tag -width…'
...
complete -c tar -s J --description '.'
complete -c tar -s k --description 'don\'t replace existing files when extracting, treat them as errors.'
complete -c tar -s K --description 'begin at member MEMBER-NAME when reading the archive.'
complete -c tar -o '\\-keep\\-directory\\-symlink' --description 'preserve existing symlinks to directories when extracting.'
complete -c tar -o '\\-keep\\-newer\\-files' --description 'don\'t replace existing files that are newer than their archive copies.'
...
complete -c tar -o '\\-occurrence' --description 'process only the NUMBERth occurrence of each file in the archive; this option…'
...
complete -c tar -o '\\-one\\-top\\-level' --description 'create a subdirectory to avoid having loose files extracted.'
complete -c tar -o '\\-overwrite' --description 'overwrite existing files when extracting.'
complete -c tar -o '\\-overwrite\\-dir' --description 'overwrite metadata of existing directories when extracting (default).'
...
complete -c tar -s p --description 'extract information about file permissions (default for superuser).'
...
complete -c tar -s s --description 'member arguments are listed in the same order as the files in the archive.'
complete -c tar -s S --description 'handle sparse files efficiently.'
complete -c tar -o '\\-same\\-owner' --description 'try extracting files with the same ownership as exists in the archive (defaul…'
complete -c tar -o '\\-no\\-same\\-owner' --description 'extract files as yourself (default for ordinary users).'
complete -c tar -o '\\-no\\-same\\-permissions' --description 'apply the user\'s umask when extracting permissions from the archive (default …'
complete -c tar -o '\\-no\\-seek' --description 'archive is not seekable.'
complete -c tar -o '\\-selinux' --description 'Enable the SELinux context support.'
complete -c tar -o '\\-no\\-selinux' --description 'Disable the SELinux context support.'
complete -c tar -o '\\-show\\-defaults' --description 'show tar defaults.'
complete -c tar -o '\\-show\\-omitted\\-dirs' --description 'when listing or extracting, list each directory that does not match search cr…'
complete -c tar -o '\\-show\\-snapshot\\-field\\-ranges' --description 'show valid ranges for snapshot-file fields.'
complete -c tar -o '\\-show\\-transformed\\-names' --description 'show file or archive names after transformation.'
complete -c tar -o '\\-skip\\-old\\-files' --description 'don\'t replace existing files when extracting, silently skip over them.'
complete -c tar -o '\\-sort' --description 'directory sorting order: none (default), name or inodedirectory sorting order…'
...
complete -c tar -o '\\-suffix' --description 'backup before removal, override usual suffix (\'~\' unless overridden by enviro…'
...
complete -c tar -o '\\-totals' --description 'print total bytes after processing the archive; with an argument - print tota…'
...
complete -c tar -o '\\-unquote' --description 'unquote input file or member names (default).'
complete -c tar -o '\\-no\\-unquote' --description 'do not unquote input file or member names.'
...
complete -c tar -s V --description 'create archive with volume name TEXT; at list/extract time, use TEXT as a glo…'
...
complete -c tar -o '\\-xattrs' --description 'Enable extended attributes support.'
complete -c tar -o '\\-xattrs\\-exclude' --description 'specify the exclude pattern for xattr keys.'
complete -c tar -o '\\-xattrs\\-include' --description 'specify the include pattern for xattr keys.'
complete -c tar -o '\\-no\\-xattrs' --description 'Disable extended attributes support.'
complete -c tar -s z --description '.'
complete -c tar -s Z --description 'El ENVIRONMENT The behavior of tar is controlled by the following environment…'
