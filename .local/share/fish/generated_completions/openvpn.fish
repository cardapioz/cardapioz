...
complete -c openvpn -l connect-retry --description 'For  --proto tcp-client, take  n as the number of seconds to wait between con…'
complete -c openvpn -l connect-timeout --description 'For  --proto tcp-client, set connection timeout to  n seconds (default=10).'
complete -c openvpn -l connect-retry-max --description 'For  --proto tcp-client, take  n as the number of retries of connection attem…'
...
complete -c openvpn -l max-routes --description 'Allow a maximum number of n  --route options to be specified, either in the l…'
...
complete -c openvpn -l comp-lzo --description 'Use fast LZO compression -- may add up to 1 byte per packet for incompressibl…'
...
complete -c openvpn -l server-poll-timeout --description 'when polling possible remote servers to connect to in a round-robin fashion, …'
...
complete -c openvpn -l auth --description 'Authenticate packets with HMAC using message digest algorithm  alg.'
...
complete -c openvpn -l no-iv --description '(Advanced) Disable OpenVPN\'s use of IV (cipher initialization vector).'
...
complete -c openvpn -l tls-version-min --description 'Enable TLS version negotiation, and set the minimum TLS version we will accep…'
...
complete -c openvpn -l tls-remote --description 'Accept connections only from a host with X509 name or common name equal to  n…'
...
complete -c openvpn -l ns-cert-type --description 'Require that peer certificate was signed with an explicit  nsCertType designa…'
...
complete -c openvpn -l register-dns --description 'Run net stop dnscache, net start dnscache, ipconfig /flushdns and ipconfig /r…'
...
complete -c openvpn -l 'remote.' --description 'Note that this option causes message and error output to be handled in the sa…'
...
complete -c openvpn -l 'up.' --description 'script_type Prior to execution of any script, this variable is set to the typ…'
