...
complete -c fsck -l adjust-size -s z --description 'This option causes reiserfsck to correct file sizes that are larger than the …'
...
complete -c fsck -l quiet --description 'This option prevents reiserfsck from reporting its rate of progress.'
