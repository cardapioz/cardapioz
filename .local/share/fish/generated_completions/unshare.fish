...
complete -c unshare -l propagation --description 'Recursively sets mount propagation flag in the new mount namespace.'
complete -c unshare -l setgroups --description 'Allow or deny  setgroups (2) syscall in user namespaces.'
