...
complete -c findmnt -s b -l bytes --description 'Print the SIZE, USED and AVAIL column in bytes rather than in a human-readabl…'
...
complete -c findmnt -s e -l evaluate --description 'Convert all tags (LABEL, UUID, PARTUUID or PARTLABEL) to the device names.'
