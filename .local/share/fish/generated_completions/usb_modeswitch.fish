...
complete -c usb_modeswitch -s n -l need-response --description 'Read the response (command status wrapper) to a mass storage command transfer.'
complete -c usb_modeswitch -s r -l response-endpoint --description 'Try to read the response to a storage command from there if option -n is acti…'
