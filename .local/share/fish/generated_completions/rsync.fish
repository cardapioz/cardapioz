...
complete -c rsync -l delete-after -l prune-empty-dirs -l 'delay-updates.' --description 'Because of this, the default delete mode when you specify --delete is now.'
...
complete -c rsync -l copy-dest -l 'link-dest.' --description 'Note that the use of the --delete option might get rid of any potential fuzzy…'
