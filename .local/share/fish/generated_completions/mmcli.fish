...
complete -c mmcli -l location-enable-gps-nmea --description 'Enable location discovery using GPS and reported with NMEA traces.'
...
complete -c mmcli -l location-get-cdma-bs --description 'Show 3GPP2 based location information (location of the CDMA base station).'
...
complete -c mmcli -l 'location-get-gps-raw;' --description '    $ sudo mmcli -m 0 --location-get     /org/freedesktop/ModemManager1/Modem…'
