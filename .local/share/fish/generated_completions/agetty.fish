...
complete -c agetty -s a -l autologin --description 'Log the specified user automatically in without asking for a login name and p…'
complete -c agetty -s c -l noreset --description 'Don\'t reset terminal cflags (control modes).'
complete -c agetty -s E -l remote --description 'If an -H fakehost option is given, then an -r fakehost option is added to the…'
...
complete -c agetty -s J -l noclear --description 'Do not clear the screen before prompting for the login name (the screen is no…'
